...
“LIBRERÍA”. Poner en uso la base de datos
generada. La misma estará conformada por 8
tablas, con la estructura que se muestra en la
diapositiva siguiente.
2. Una vez creadas todas las tablas, insertar un
conjunto de registros en cada una de ellas,
utilizando el archivo con el nombre “SCRIPT”.
Este archivo está disponible en la sección Descargas.
*/
...
/*A partir de lo realizado en el Ejercicio 2, luego
de insertar los registros, definir las claves
primarias (Primary Key) en cada tabla. Tener
en cuenta que cada tabla tiene un campo con
el sufijo _id que identifica al campo clave.
2. Examinar los datos ingresados, e insertar 3
registros en cada una de las tablas utilizando
la sentencia INSERT del conjunto de sentencias DML (Data Manipulation Language) del
lenguaje SQL*/
...
ALTER TABLE LIBROAUTOR ADD PRIMARY KEY (libro_id, autor_id);
